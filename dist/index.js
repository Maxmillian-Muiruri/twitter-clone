...
class TwitterClone {
    constructor() {
        ...
        this.profileName = document.querySelector(".profile-info h2");
        this.profileUsername = document.querySelector(".username");
        this.profileWebsite = document.querySelector(".website");
        this.profileBio = document.querySelector(".profile-info p:nth-of-type(2)");
        this.profileLocation = document.querySelector(".location");
        this.postsFeed = document.querySelector(".posts-feed");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (this.users.length > 0) {
                    ...
                    yield this.fetchPosts(this.selectedUserId);
                }
            }
            catch (error) {
        ...
        this.postsFeed.innerHTML = this.posts
          ...
          <div class="profile-content" data-post-id="${post.id}">
            <img
              ...
              alt="${(user === null || user === void 0 ? void 0 : user.name) || "User"} profile"
            />
            <div class="profile-info">
              <h2>
                ${(user === null || user === void 0 ? void 0 : user.name) || "Unknown User"}
                <img
    ...
    fetchComments(postId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.comments = yield response.json();
